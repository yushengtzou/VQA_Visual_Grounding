...
# 篩選 data 中的每一個 category 和 bbox 的函式 
# processJson() 的依賴是 processImageWith123Bbox() 
def processJson(file_path):
    ...
    # 儲存影像 bbox 只有 3 個的字典
    imageWith3Bbox = {}
    # 儲存影像 bbox 有 1, 2, 3 個的字典
    imageWith123Bbox = {}

    # 遍歷 data['categories'] 中的每一個 category 
